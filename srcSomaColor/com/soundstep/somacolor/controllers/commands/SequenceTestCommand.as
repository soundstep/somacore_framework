package com.soundstep.somacolor.controllers.commands {
	...
	public class SequenceTestCommand extends SequenceCommand implements ISequenceCommand {
		...
		public function SequenceTestCommand() {
		...
		override protected function initializeSubCommands():void {
			addSubCommand(new ASyncEvent(ASyncEvent.CALL));
			addSubCommand(new ASyncEvent(ASyncEvent.CALL));
